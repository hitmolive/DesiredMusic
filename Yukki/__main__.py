...
async def initiate_bot():
    ...
    if STRING1 != "None":
        try:
            ...
            return
        try:
            await ASS_CLI_1.join_chat("HwMusicUpdates")
            await ASS_CLI_1.join_chat("HwBotSupport")
        except:
            pass
    ...
    if STRING2 != "None":
        try:
            ...
            return
        try:
            await ASS_CLI_2.join_chat("HwMusicUpdates")
            await ASS_CLI_2.join_chat("HwBotSupport")
        except:
            pass
    ...
    if STRING3 != "None":
        try:
            ...
            return
        try:
            await ASS_CLI_3.join_chat("HwMusicUpdates")
            await ASS_CLI_3.join_chat("HwBotSupport")
        except:
            pass
    ...
    if STRING4 != "None":
        try:
            ...
            return
        try:
            await ASS_CLI_4.join_chat("HwMusicUpdates")
            await ASS_CLI_4.join_chat("HwBotSupport")
        except:
            pass
    ...
    if STRING5 != "None":
        try:
            ...
            return
        try:
            await ASS_CLI_5.join_chat("HwMusicUpdates")
            await ASS_CLI_5.join_chat("HwBotSupport")
        except:
            pass
    ...
    if LOG_SESSION != "None":
        try:
            ...
            return
        try:
            await LOG_CLIENT.join_chat("HwMusicUpdates")
            await LOG_CLIENT.join_chat("HwBotSupport")
        except:
            pass
