...
async def gstats(_, message):
    ...
    response = await message.reply_photo(
        photo="https://telegra.ph/file/f6e5a34f3268114f07920.jpg", caption="➥ 𝐆𝐞𝐭𝐭𝐢𝐧𝐠 𝐃𝐞𝐬𝐢𝐫𝐞𝐝 𝐒𝐭𝐚𝐭𝐬 ❗"
    )
    end = datetime.now()
...
**Bots:** {bots_ub5}
**Users:** {privates_ub5}"""
        await CallbackQuery.edit_message_text(msg, reply_markup=stats6)￼Enter
