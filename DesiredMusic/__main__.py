...
from DesiredMusic.Modules import ALL_MODULES


async def desired_startup():
    LOGGER.info("[•] Loading Modules...")
    for module in ALL_MODULES:
        importlib.import_module("DesiredMusic.Modules." + module)
...
if __name__ == "__main__":
    asyncio.get_event_loop().run_until_complete(Desired_startup())
    LOGGER.error("Desired Music Bot Stopped.")
